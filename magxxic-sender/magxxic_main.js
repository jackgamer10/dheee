...
function printBanner(version = "2.2.1") {
    ...
    const vMid = chalk.cyan("                 @@@@@@@@@@@@@@@              ") + chalk.cyan("@@@@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@@   ") + chalk.red.bold("MMMM      MMMM") + chalk.cyan("   @@@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@    ") + chalk.red.bold("MMMMM    MMMMM") + chalk.cyan("    @@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@    ") + chalk.red.bold("MM MM   MM MM ") + chalk.cyan("    @@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@    ") + chalk.red.bold("MM  MM MM  MM ") + chalk.cyan("    @@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@    ") + chalk.red.bold("MM   MMM   MM ") + chalk.cyan("    @@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@@   ") + chalk.red.bold("MM         MM") + chalk.cyan("   @@@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@@@@              ") + chalk.cyan("@@@@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@@@@@@   ") + chalk.green.bold("@@  @@") + chalk.cyan("   @@@@@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@@@@@@@        ") + chalk.cyan("@@@@@@@@@@@@@@@@@@\n") +
                 chalk.cyan("                @@@@@@@@@@@@@@@@@@@@  ") + chalk.green.bold("@@@@") + chalk.cyan("  @@@@@@@@@@@@@@@@@@");

    const vBot = chalk.cyan(`
                @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
"      ___  ___  _______  ________  ___  ___  ________  ___  ________  \n" +
"     |\\  |\\  |\\  ___  |\\   ____|\\  |\\  |\\  |\\   ____|\\  |\\   ____\\ \n" +
"     \\ \\  \\ \\  \\ \\   __/|\\ \\  \\___|\\ \\  \\ \\  \\ \\  \\___|\\ \\  \\ \\  \\___| \n" +
"      \\ \\  \\ \\  \\ \\  \\_|/_\\ \\  \\  __\\ \\  \\ \\  \\ \\  \\    \\ \\  \\ \\  \\    \n" +
"       \\ \\  \\ \\  \\ \\  \\_|\\ \\ \\  \\|\\  \\ \\  \\ \\  \\ \\  \\____\\ \\  \\ \\  \\____\n" +
"        \\ \\__\\ \\__\\ \\_______\\ \\______\\ \\__\\ \\__\\ \\_______\\ \\__\\ \\_______\\\n" +
